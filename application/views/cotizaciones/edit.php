...
$page_title = isset($title) ? $title : 'Editar Cotización';
$page_type = 'forms';
$active_menu = 'cotizaciones';
$page_header = isset($title) ? $title : 'Editar Cotización';
$page_subtitle = 'Modificar cotización existente';
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    <i class="fas fa-edit me-2"></i>Editar Cotización #<?php echo $quotation->quotation_number; ?>
                </h5>
            </div>
            <div class="card-body">
                ...
                <?php echo form_open('cotizaciones/edit/'.$quotation->id, ['id' => 'editQuotationForm']); ?>
                                ...
                                <select class="form-select <?php echo (form_error('client_id')) ? 'is-invalid' : ''; ?>" 
                                    ...
                                    <?php foreach($clients as $client): ?>
                                        <option value="<?php echo $client->id; ?>" 
                                                <?php echo set_select('client_id', $client->id, $quotation->client_id == $client->id); ?>>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="date" 
                                       ...
                                       id="quotation_date" 
                                       name="quotation_date" 
                                       value="<?php echo set_value('quotation_date', $quotation->quotation_date); ?>" 
                                       required>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating mb-3">
                                <input type="number" 
                                       ...
                                       id="validity_days" 
                                       name="validity_days" 
                                       value="<?php echo set_value('validity_days', $quotation->validity_days); ?>" 
                                       min="1" 
                                       max="365" 
                                       required>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating mb-3">
                                <select class="form-select <?php echo (form_error('currency')) ? 'is-invalid' : ''; ?>" 
                                        ...
                                        name="currency" 
                                        required>
                                    <option value="MXN" <?php echo set_select('currency', 'MXN', $quotation->currency == 'MXN'); ?>>MXN - Peso Mexicano</option>
                                    <option value="USD" <?php echo set_select('currency', 'USD', $quotation->currency == 'USD'); ?>>USD - Dólar Estadounidense</option>
                                    <option value="EUR" <?php echo set_select('currency', 'EUR', $quotation->currency == 'EUR'); ?>>EUR - Euro</option>
                                </select>
                                <label for="currency">
                        ...
                        <div class="col-md-3">
                            <div class="form-floating mb-3">
                                <select class="form-select <?php echo (form_error('payment_terms')) ? 'is-invalid' : ''; ?>" 
                                        ...
                                        name="payment_terms" 
                                        required>
                                    <option value="CREDITO" <?php echo set_select('payment_terms', 'CREDITO', $quotation->payment_terms == 'CREDITO'); ?>>CREDITO</option>
                                    <option value="CONTADO" <?php echo set_select('payment_terms', 'CONTADO', $quotation->payment_terms == 'CONTADO'); ?>>CONTADO</option>
                                    <option value="30 DIAS" <?php echo set_select('payment_terms', '30 DIAS', $quotation->payment_terms == '30 DIAS'); ?>>30 DÍAS</option>
                                    <option value="60 DIAS" <?php echo set_select('payment_terms', '60 DIAS', $quotation->payment_terms == '60 DIAS'); ?>>60 DÍAS</option>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating mb-3">
                                <input type="text" 
                                       ...
                                       value="<?php echo set_value('delivery_location', $quotation->delivery_location); ?>" 
                                       required>
                        ...
                        <div class="col-md-3">
                            <div class="form-floating mb-3">
                                <input type="number" 
                                       ...
                                       id="tax_rate" 
                                       name="tax_rate" 
                                       value="<?php echo set_value('tax_rate', $quotation->tax_rate); ?>" 
                                       step="0.01" 
                                       min="0" 
                                       max="100" 
                                       required>
                        ...
                        <div class="col-12">
                            <div class="form-floating mb-3">
                                <textarea class="form-control" 
                                          ...
                                          style="height: 100px"><?php echo set_value('notes', $quotation->notes); ?></textarea>
                                <label for="notes">
...
function initializeQuotationForm() {
    ...
    jQuery('#editQuotationForm').on('keypress', function(e) {
    ...
    jQuery('#editQuotationForm input, #editQuotationForm textarea, #editQuotationForm select').on('keypress', function(e) {
        if (e.which === 13) { // 13 es el código de Enter
            e.preventDefault();
            return false;
        }
...
function loadExistingItems() {
    ...
    <?php if(isset($quotation_items) && !empty($quotation_items)): ?>
        console.log('Items encontrados: <?php echo count($quotation_items); ?>');
        <?php 
        $items_data = [];
        ...
        ?>
        const existingItems = <?php echo json_encode($items_data); ?>;
        existingItems.forEach(function(itemData) {
            ...
            console.log('Item cargado:', newItem);
            items.push(newItem);
        });
    <?php else: ?>
        console.log('No hay items existentes, agregando uno por defecto');
...
function initializeAfterJQuery() {
    ...
    jQuery(document).ready(function() {
        console.log('jQuery está listo, inicializando formulario de edición...');
...
function createHiddenFields() {
    ...
    items.forEach(function(item, index) {
        const form = jQuery('#editQuotationForm');
